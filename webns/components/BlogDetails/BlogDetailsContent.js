                            ...
                            <div className={styles.blogDetailsDesc}>
                                <div className={styles.articleContent}>
                                    ...
                                    <ul className={styles.entryMeta}>
                                        <li>14 June, 2021</li>
                                        <li>by: <Link href="/author" legacyBehavior><a>Brandy</a></Link></li>
                                        <li>(02) Comments</li>
                                    </ul>
                                    ...
                                    <blockquote className={styles.blockquote}>
                                        ...
                                        <p>Aenean sollicitudin lorem biendum auctor nisi elit consequat ipsum nec sagittis sem nibh id elit. Duis sedo odio sit amet nibh doy Tasim.</p>
                                    </blockquote>
