...
import styles from '@/components/ProductsDetails/ProductsSidebar/ProductsSidebar.module.css'
            ...
            <div className={styles.widgetArea}>
                <div className={`${styles.widget} ${styles.widgetServices}`}>
                    ...
                    <ul className={styles.servicesList}>
                        ...
                        <li>
                            <Link href="/services-details" legacyBehavior>
                                <a>Web Development Product <i className="ri-arrow-right-s-line"></i></a>
                            </Link>
                        </li>
                        <li>
                            <Link href="/services-details" legacyBehavior>
